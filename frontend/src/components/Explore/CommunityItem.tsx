  ...
  return (
    <li className="flex flex-col bg-black-100 h-[300px] rounded-[8px]">
      ...
      >
        {community.banner && (
          <img
            className="object-center object-cover aspect-[3/1] rounded-[inherit]"
      ...
      <div className="relative p-[32px] pt-[36px] flex-auto">
        ...
        <article className="flex flex-col justify-between h-full">
          <div className="overflow-hidden]">
            <h1
              className={
                "text-p font-bold text-white-100 overflow-hidden" +
            ...
            <p
              className={
                "text-p text-white-200 overflow-hidden text-ellipsis" +
                " text-nowrap"
              }
            >
