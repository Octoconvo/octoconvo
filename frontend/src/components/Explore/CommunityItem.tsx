        ...
        <div className="relative p-[32px] pt-[36px] flex-auto">
          ...
          <article className="flex flex-col justify-between h-full">
            <div className="overflow-hidden">
              <h1 className="text-start text-p font-bold text-white-100 overflow-hidden text-ellipsis text-nowrap">
                {unescapeString(community.name)}
              </h1>
              <p className="text-start text-p text-white-200 overflow-hidden text-ellipsis text-nowrap">
